            ...
            <div class="header-content-inner">
				...
				<a class="btn btn-primary btn-lg"
					...
					<?php
						if(isset($_SESSION['login_user'])&&$_SESSION['user_type']=='Customer')
						{
							echo "<a href=\"book_tickets.php\"><i class=\"\" aria-hidden=\"true\"></i> Book Now</a>";
						}
						else if(isset($_SESSION['login_user'])&&$_SESSION['user_type']=='Administrator')
						{
							echo "<a href=\"admin_ticket_message.php\"><i class=\"\" aria-hidden=\"true\"></i> Book Now</a>";
						}
						else
						{
							echo "<a href=\"login_page.php\"><i class=\"\" aria-hidden=\"true\"></i> Book Now</a>";
						}
					?> 
				</a>
