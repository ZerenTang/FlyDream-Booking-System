	...
	<body>
		...
		<?php
			...
			while($count<=$no_of_pass)
			{
					...
					echo "<td class=\"fix_table_short\">Passenger's Inflight Meal ($250)</td>";					
					echo "</tr>";
					echo "<tr>";
				...
				echo "<tr>";
				echo "<td class=\"fix_table_short\">Do you want access to our Premium Lounge? ($300)</td>";
				echo "<td class=\"fix_table_short\">Do you want to opt for Priority Checkin? ($200)</td>";
				echo "<td class=\"fix_table_short\">Do you want to purchase Travel Insurance? ($100)</td>";
				echo "</tr>";
				echo "<tr>";
